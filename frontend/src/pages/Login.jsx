    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-cyan-50 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-5xl overflow-hidden">
        <div className="flex flex-col md:flex-row">
          {/* Left Side - Logo */}
          <div className="md:w-1/2 p-8 flex items-center justify-center bg-white dark:bg-gray-800 relative">
            ...
            <div className="text-center">
              ...
              <div className="mt-8">
                <p className="text-sm text-gray-500 dark:text-gray-300">
                  Are you a candidate?{' '}
                  <a href="/careers/login" className="text-indigo-600 font-medium hover:underline">Candidate portal →</a>
                </p>
              </div>
            </div>
          </div>
